...
export class SkeletonAnimation extends EntityAnimation {
  ...
  public createSpriteMap(): Map<EntityState, SpriteResource> {
    return new Map([
      ...
      [EntityState.MOVE,    new SpriteResource('character/skeleton/move.png',    3, 10).setDirection(SpriteDirection.RIGHT)],
      [EntityState.ATTACK,  new SpriteResource('character/skeleton/attack.png',  7, 10).setDirection(SpriteDirection.RIGHT)],
