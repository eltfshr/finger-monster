...
export class BlueSlimeAudio implements EntityAudio {
  ...
  public constructor() {
    this.audio = new AudioResource('audio/slime.mp3');
    this.audioMap = new Map([
      [EntityState.IDLE, new AudioResource('audio/slime.mp3')],
      [EntityState.ATTACK, new AudioResource('audio/slime.mp3')],
      [EntityState.HURT, new AudioResource('audio/slime.mp3')],
    ]);
  }
