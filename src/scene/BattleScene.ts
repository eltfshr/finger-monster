...
export class BattleScene extends Scene {
  ...
  private readonly uiManager          = new BattleUIManager();
  private readonly eventManager       = new BattleEventManager(this.uiManager);
  ...
  public update(): void {
    ...
    if (this.player.getCurrentState() !== EntityState.DIE) {
